...
class ThirdNewsView extends StatefulWidget {
  const ThirdNewsView({super.key});

  @override
  State<ThirdNewsView> createState() => _ThirdNewsViewState();
}

class _ThirdNewsViewState extends State<ThirdNewsView> {
  String? urlTwo;
  String? urlOne;
  String? urlThree;
  ...
  Future<void> fetchData() async {
    ...
    await getImageUrlTwo('24701-nature-natural-beauty.jpg');
          ...
          child: Column(
            ...
            children: [
              Container(
                  height: 200,
                  child: FutureBuilder(
                      future: getImageUrlThird('24701-nature-natural-beauty.jpg'),
