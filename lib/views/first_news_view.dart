...
class FirstNewsView extends StatefulWidget {
  const FirstNewsView({super.key});

  @override
  State<FirstNewsView> createState() => _FirstNewsViewState();
}

class _FirstNewsViewState extends State<FirstNewsView> {
  String? urlTwo;
  String? urlOne;
  String? urlThree;
              ...
              Container(
                  ...
                  child: FutureBuilder(
                      ...
                      builder: (context, snapshot) {
                        ...
                        } else if (!snapshot.hasData || urlOne == null) {
                          return Center(
                            child: Image.asset(
